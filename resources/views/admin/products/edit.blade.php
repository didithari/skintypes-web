        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="form-grid">
            ...
            <div class="field">
                ...
                <select id="c2_iritatif" name="c2_iritatif" required>
                    <option value="1" @selected(old('c2_iritatif', $product->c2_iritatif) == 1)>1 - Rendah</option>
                    <option value="2" @selected(old('c2_iritatif', $product->c2_iritatif) == 2)>2 - Sedang</option>
                    <option value="3" @selected(old('c2_iritatif', $product->c2_iritatif) == 3)>3 - Tinggi</option>
                </select>
