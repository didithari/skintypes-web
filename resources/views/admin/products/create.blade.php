        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="form-grid">
            ...
            <div class="field">
                ...
                <select id="c1_kandungan" name="c1_kandungan" required>
                    <option value="1" @selected(old('c1_kandungan') == 1)>1 - Rendah = 1</option>
                    <option value="2" @selected(old('c1_kandungan', 2) == 2)>2 - Sedang = 2</option>
                    <option value="3" @selected(old('c1_kandungan') == 3)>3 - Tinggi = 3</option>
                    <option value="4" @selected(old('c1_kandungan') == 4)>4 - Sangat Tinggi ≥4</option>
                </select>
            </div>
            ...
            <div class="field">
                ...
                <input id="c3_harga_info" type="text" value="Otomatis dari input harga" disabled style="background:#f3f4f6; color:#6b7280;">
            </div>
            ...
            <div class="field">
                ...
                <select id="c4_tekstur" name="c4_tekstur" required>
                    <option value="gel" @selected(old('c4_tekstur') == 'gel')>Gel = 3</option>
                    <option value="foam" @selected(old('c4_tekstur', 'foam') == 'foam')>Foam = 2</option>
                    <option value="cream" @selected(old('c4_tekstur') == 'cream')>Cream = 1</option>
                </select>
            </div>

            <div class="field form-full">
                <label for="link_produk">Link Produk (Toko Online)</label>
                <input type="url" id="link_produk" name="link_produk" value="{{ old('link_produk') }}" placeholder="https://tokopedia.com/...">
            </div>
