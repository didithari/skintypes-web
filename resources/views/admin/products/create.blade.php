        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="form-grid">
            ...
            <div class="field">
                ...
                <select id="c1_kandungan" name="c1_kandungan" required>
                    <option value="1" @selected(old('c1_kandungan') == 1)>1 - Rendah</option>
                    <option value="2" @selected(old('c1_kandungan', 2) == 2)>2 - Sedang</option>
                    <option value="3" @selected(old('c1_kandungan') == 3)>3 - Tinggi</option>
                    <option value="4" @selected(old('c1_kandungan') == 4)>4 - Sangat Tinggi</option>
                </select>
            </div>
            ...
            <div class="field">
                ...
                <select id="c4_tekstur" name="c4_tekstur" required>
                    <option value="gel" @selected(old('c4_tekstur') == 'gel')>Gel</option>
                    <option value="foam" @selected(old('c4_tekstur', 'foam') == 'foam')>Foam</option>
                    <option value="cream" @selected(old('c4_tekstur') == 'cream')>Cream</option>
                </select>
            </div>
