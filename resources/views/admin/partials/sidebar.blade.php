<aside style="background:#fff; border-right:1px solid #e5e7eb; display:flex; flex-direction:column; justify-content:space-between;">
    <div>
        ...
        <nav style="padding:18px 14px; display:flex; flex-direction:column; gap:6px;">
            ...
            <a href="{{ route('admin.products.index') }}" style="padding:11px 14px; border-radius:10px; text-decoration:none; color:{{ request()->routeIs('admin.products.index', 'admin.products.create', 'admin.products.edit') ? '#059669' : '#4b5563' }}; background:{{ request()->routeIs('admin.products.index', 'admin.products.create', 'admin.products.edit') ? '#e8f5ee' : 'transparent' }}; font-weight:600;">👜 Products</a>
            <a href="{{ route('admin.products.saw-preview') }}" style="padding:11px 14px; border-radius:10px; text-decoration:none; color:{{ request()->routeIs('admin.products.saw-preview') ? '#059669' : '#4b5563' }}; background:{{ request()->routeIs('admin.products.saw-preview') ? '#e8f5ee' : 'transparent' }}; font-weight:600;">📊 SAW Preview</a>
